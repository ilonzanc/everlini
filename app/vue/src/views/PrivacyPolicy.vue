<template>
  <div id="privacy-policy" class="content">
    <div class="container">
      ...
      <p>When ordering or registering on our site, as appropriate, you may be asked to enter your name, email address, phone number, location, date of birth, interests or other details to help you with your experience.</p>
      ...
      <h2>Google</h2>
      <p>Google's advertising requirements can be summed up by <a href="https://support.google.com/adwordspolicy/answer/1316548?hl=en">Google's Advertising Principles</a>. They are put in place to provide a positive experience for users.</p>
      ...
      <p>Everlini</p>
      <p><i class="fa fa-envelope"></i><a href="mailto:zancaneri@gmail.com">zancaneri@gmail.com</a></p>
...
<script>
  export default {
    ...
    mounted() {
      console.log("Privacy Policy Vue Component mounted");
    },
    methods: {
    }
  };
