    ...
    <header>
      <nav>
        <ul>
          ...
          <li v-if="session.profile_id != ''"><router-link to="/" class="btn">Uitloggen</router-link></li>
          <li v-if="session.profile_id == ''"><router-link to="/aanmelden" class="btn">Aanmelden</router-link></li>
        </ul>
      </nav>
    </header>
    <main>
