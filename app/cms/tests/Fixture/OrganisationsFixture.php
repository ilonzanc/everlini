...
class OrganisationsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'organisation_user_idx' => ['type' => 'index', 'columns' => ['creator_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'name_UNIQUE' => ['type' => 'unique', 'columns' => ['name'], 'length' => []],
            'organisation_user' => ['type' => 'foreign', 'columns' => ['creator_id'], 'references' => ['users', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
